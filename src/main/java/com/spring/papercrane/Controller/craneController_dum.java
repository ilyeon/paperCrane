...
public class craneController_dum {
	@Autowired
	...
	public @ResponseBody JSONObject randCrane(HttpServletRequest request) throws Exception {
		...
		String userid = "test000"; // request.getParameter() 더미
	...
	public @ResponseBody JSONObject myCrane(HttpServletRequest request) throws Exception {
		...
		String userid = "test123"; // request.getParameter() 더미
		int num=1; //더미 
	...
	public @ResponseBody void insertCrane() {
		System.out.println("insert Crane");
		
		String userid="test123"; //더미
		String craneText="글내용ddd"; //더미
	...
	public @ResponseBody void insertReple() {
		System.out.println("insert Reple");
		
		String reUserid="test123"; //더미 선택된 글 본 주인 아이디
		int reNum=1; //더미 선택된 글 번호
	
		
		String repleText="asdf"; //더미
		int color=3; //더미 
